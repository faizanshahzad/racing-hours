...
function go() {
	...
	course.setAttribute(
		"viewBox",
		`-10 -10 ${raceLength} ${riders.length * 20 + 20}`
	);
	...
	knobs: [
      ...
      `,
		...
		},
		{
			...
			onChange: (e) => {
				e.target.checked
					? document.querySelector(".ground").setAttribute("filter", "url(#mud)")
					: document.querySelector(".ground").setAttribute("filter", "");
			}
		}
	]
};
